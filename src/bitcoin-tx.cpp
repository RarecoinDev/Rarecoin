...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rarecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rarecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rarecoin transaction") + "\n" +
              "  rarecoin-tx [options] -create [commands]   " + _("Create hex-encoded rarecoin transaction") + "\n" +
              "\n";
