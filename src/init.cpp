...
{
    return "Copyright 2009-2017 The Bitcoin Core developers. Copyright 2018 Rarecoin developers. This is experimental software.\n" +
...
bool AppInitParameterInteraction()
{
    ...
    if (gArgs.IsArgSet("-minrelaytxfee")) {
        ...
        // Rarecoin - Allow 0 fee transactions
