    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightText   = QString::fromUtf8("Copyright 2018 The Rarecoin developers.\nCopyright 2009-2017 The Bitcoin Core Developers.");//QString::fromUtf8(CopyrightHolders(strprintf("\xc2\xA9 %u-%u ", 2009, COPYRIGHT_YEAR)).c_str());
